...
app.post('/api/diablo-z-compute', (req, res) => {
    try {
        ...
        let last = history[0]; // Most recent round
        let secondLast = history[1];
        let thirdLast = history[2];

        // Count recent bigs/smalls for momentum
        ...
        if (version === "PRIVATE_GOD_MODE") {
            ...
            // Agar market mein ek taraf heavy rush hai, toh uska ULTA (inverse) do
            if (bigCount >= 4) {
                prediction = "SMALL";
                confidence = "92%";
            } else if (bigCount <= 1) {
        ...
        // ==========================================
            ...
            // Pure mathematical weight calculation based on sum of recent numbers
        ...
        // ==========================================
            ...
            // Pattern flow tracking (Alternating or repeating check)
            if (last.size === secondLast.size) {
                prediction = last.size; // Continue momentum
                confidence = "88%";
            } else {
        ...
        // ==========================================
            ...
            // Strict continuation of the current running streak/dragon
        ...
        // ==========================================
            ...
            // Follows where the crowd volume wave is leaning towards
            prediction = (bigCount >= 3) ? "BIG" : "SMALL";
            confidence = "87%";
        }

        // Fallback for Auto-Switch or general
        else {
